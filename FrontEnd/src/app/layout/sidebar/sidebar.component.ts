...
export class SidebarComponent {
  ...
  menuItems = [
    ...
    { label: 'الحركات المخزنية', icon: 'pi pi-arrows-alt', route: '/inventory/transactions' },
    ...
    { label: 'قائمة الدخل', icon: 'pi pi-chart-line', route: '/accounting/financial-reports/income-statement' },
    { label: 'الميزانية العمومية', icon: 'pi pi-chart-bar', route: '/accounting/financial-reports/balance-sheet' },
